...
Every export carries the same disclaimer the screen does. A PDF outlives the
...
from rxconcile.export.common import DISCLAIMER, ExportContext
...
__all__ = ["ExportContext", "DISCLAIMER", "build_json", "build_pdf", "build_xlsx"]
